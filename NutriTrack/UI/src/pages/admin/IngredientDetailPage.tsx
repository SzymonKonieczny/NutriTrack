  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-2">
        <div>
          <Link to="/admin/ingredients" className="text-sm text-muted" style={{ display: 'block', marginBottom: '0.25rem' }}>← Back to Ingredients</Link>
        ...
        <div className="card mb-2">
          ...
          <div className="flex gap-2 items-center">
            <div className="form-group" style={{ flex: 2 }}>
              <label htmlFor="im-micronutrient">Micronutrient</label>
              <select id="im-micronutrient" className="form-select" value={formMicronutrientId} onChange={(e) => setFormMicronutrientId(e.target.value)}>
            ...
            <div className="form-group" style={{ flex: 1 }}>
              <label htmlFor="im-amount">Per 100g</label>
              <input id="im-amount" type="number" className="form-input" value={formAmount} onChange={(e) => setFormAmount(e.target.value)} min="0" step="0.01" placeholder="mg" />
            </div>
