...
export default function MyRecipeIngredientsPage() {
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-2">
        <div>
          <Link to="/my-recipes" className="text-sm text-muted" style={{ display: 'block', marginBottom: '0.25rem' }}>← Back to My Recipes</Link>
          <h1>{recipe.name}</h1>
        ...
        <div className="card mb-2">
          ...
          <div className="flex gap-2 items-center">
            <div className="form-group" style={{ flex: 2 }}>
              <label htmlFor="my-ri-ingredient">Ingredient</label>
              <select id="my-ri-ingredient" className="form-select" value={formIngredientId} onChange={(e) => setFormIngredientId(e.target.value)}>
            ...
            <div className="form-group" style={{ flex: 1 }}>
              <label htmlFor="my-ri-amount">Amount (g)</label>
              <input id="my-ri-amount" type="number" className="form-input" value={formAmount} onChange={(e) => setFormAmount(e.target.value)} min="0" step="0.1" placeholder="g" />
            </div>
